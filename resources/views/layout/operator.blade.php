...
<body>
    <div class="head position-absolute w-100" style="background-color: {{ ($title === 'Home') ? '#606C5D' : (($title === 'transaction') ? '#22A699' : (($title === 'User') ? '#F2A154' : '')) }}; min-height: 300px;"></div>
    <section id="sidebar">
        <div class="container shadow rounded ">
         ...
         <div class="sidebar">
           ...
           <li class="nav-item mb-3">
             <a class="nav-link d-flex" href="/transaction">
               <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="fa-solid fa-repeat fa-xl {{ ($title === "transaction") ? 'fa-bounce' : '' }}" style="color: #213555"></i>
               </div>
