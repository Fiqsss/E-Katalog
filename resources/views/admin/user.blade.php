                ...
                <div class="card-body shadow">
                    <div class="card text-center shadow">
                        <div class="card-body ">
                            ...
                            <p class="card-text fw-bold">Email: <span class="fw-bold" style="color: #FF6969"> {{ $item['email'] }}</span></p>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="{{ route('updateuser', $item['id']) }}"  method="POST" enctype="multipart/form-data">
                    ...
                    <input value="{{ $item['name'] }}" name="edtname" id="user" class="form-control" type="text">
                    <br>
                    <label for="email">Email</label>
                    <input value="{{ $item['email'] }}" name="edtemail" id="email" class="form-control" type="email">
                    <br>
